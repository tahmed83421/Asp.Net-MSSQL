<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Survey-admin.aspx.cs" Inherits="BilliardScoreboard.Survey_admin" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="color:white; font-size:40px; text-align:center">
          <b>UserId:&nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; </b><asp:TextBox ID="txtUserId" runat="server"></asp:TextBox><br /><br />
            ...
            <asp:Button ID="btnLogin" runat="server" style="font-size:35px;" Text="Login" OnClick="btnLogin_Click" />
        </div>
