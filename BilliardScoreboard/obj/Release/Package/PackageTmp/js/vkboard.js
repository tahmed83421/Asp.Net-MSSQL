...
VKeyboard.prototype = {
  ...
  _setup_key: function(parent, id, top, left, width, height, text_align, line_height, font_size, font_weight, padding_left, padding_right)
  {
    ...
    var key = exists ? exists.parentNode : document.createElement("li");
                       ...
                       do_gap, start_layout_index)
  {
    ...
    var fs = font_size || this.fontsize || "20px";
    ...
    if(!exists)
    {
      ...
      ct.style.zIndex = 999;
      ct.style.fontSize = "9.002px";
      //ct.style.width = "750px";
      ct.style.margin = "25px auto";
      ct.style.marginTop = "25px";

      if(do_embed)
        ct.style.position = "relative";
      else
      {
          ct.style.position = "inherit";
        ...
        ct.style.top = "370px", ct.style.left = "25%";
      }
    ...
    var kb_main = exists ? kb.childNodes[0] : document.createElement("ul"), ks = kb_main.style;
    if(!exists)
    {
    ...
    if(!exists || changed)
    {
      var mag = parseFloat(fs) / 14.0, cell = Math.floor(35.0 * mag), dcell = 2 * cell, gap = this.gap;
      ...
      kb.style.width = ks.width = "1161px";  //w + "px";
    }
  ...
  _create_numpad: function(container_id, parent)
  {
    ...
    var mag = parseFloat(fs) / 14.0, cell = Math.floor(35.0 * mag);
  ...
  _handle_lang_menu: function(event)
  {
    ...
    else
    {
      ...
      var mag = parseFloat(fs) / 14.0, cell = Math.floor(35.0 * mag), cp = cell + "px", lh = (cell - 2) + "px", w = String(102 * mag) + "px";
  ...
  avail_langs: [["It", "Italiano (It)"],["Us", "English (US)"]],
